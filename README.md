...
**Android cài đặt (Termux)**
    ...
    pkg install git -y && git clone https://github.com/ducxoan94/vss && cd vss && chmod +x * && echo 'PATH="$PATH:$HOME/vss"' >> $HOME/.bashrc && source $HOME/.bashrc && t
...
##### app socksdroid
https://github.com/ducxoan94/vss/raw/master/SocksDroid-termi.apk
